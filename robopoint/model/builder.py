...
import torch
from robopoint.model import *
from robopoint.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
...
def load_pretrained_model(
    ...
    **kwargs,
    ...
    if "lora" in model_name.lower() and model_base is not None:
        from robopoint.model.language_model.llava_llama import LlavaConfig
